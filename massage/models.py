...
class serviceInfo(models.Model):
	...
	service_income_account = models.ForeignKey(chartofaccounts,on_delete=models.PROTECT,null=False,related_name="income_account")
	def __str__(self):
...
class journalcollections(models.Model):
	...
	account_id = models.ForeignKey(chartofaccounts,on_delete=models.PROTECT,null=True,related_name="journal_account")
	...
	def __str__(self):
		return f"{self.transaction_date} | {self.account_id}  | $ {self.debits} | $ {self.credits} | {self.description} | Journal #{self.journalid.id}"
...
class logs(models.Model):
	...
	account_involved = models.ForeignKey(chartofaccounts,on_delete=models.PROTECT,null=True,related_name="logs_account")
